        ...
        if (c.hostName.indexOf(".suning.com") != -1) {
            ...
            if (c.hostName.indexOf(".cnsuning.com") != -1) {
                ...
                if (c.hostName.indexOf("pre") != -1) {
                    ...
                    c.hostName = c.protocol + "//ipservicesit.cnsuning.com"
                }
            } else {
                c.cookieDomain += c.hostName;
                c.hostName = "http://localhost:8080/ip-web"
            }
        }
...
(function (d) {
    ...
    i.prototype = {
        ...
        getAllDetail: function (r, E) {
            ...
            D.append(m);
            var A = d('<div class="ui-city-group-header"><p class="address-title">常用地址：</p></div>');
            ...
            var q = d('<ul class="tab-panel pr-panel"></ul><ul class="tab-panel ct-panel"><li>正在加载中...</li></ul><ul class="tab-panel ds-panel active"><li></li></ul>');
            o.setInfo = o.getInfo;
            if (!!r.state) {
                var p = d("<li></li>");
                q.eq(0).append(p);
        ...
        getCities: function (u, t, l, m, k, n) {
            ...
            t.find(".pr-panel a").on("click", function (y) {
                ...
                u.children(":eq(1)").find("a").html("请选择市").end().end().children(":eq(2)").removeClass("active").find("a").html("请选择县区");
                        ...
                        p.getDefaultDistrict(B[0].defaultId, function (D) {
                            ...
                            if (!!j.city) {
                                p.setDefaultAddress(p.setInfo, function (F) {
                                    ...
                                    G.text() == E.text() && d.trim(G) != "吉林" ? k.find(".pr").addClass("dn") : k.find(".pr").removeClass("dn")
                                })
                            }
        ...
        getDistricts: function (q, m, k, l, j) {
            ...
            m.find(".ct-panel a").on("click", function (s) {
                ...
                var t = d(this).text();
                if (!n.city) {
                    q.children(":eq(2)").find("a").html("请选择县区");
                    p.html("");
                    ...
                    o.getDefaultDistrict(u, function (y) {
                        ...
                        z == w && d.trim(z) != "吉林" ? k.find(".pr").addClass("dn") : k.find(".pr").removeClass("dn");
        ...
        setDetailAddress: function (j, o, l, k) {
            ...
            l.find(".ds-panel a").on("click", function (q) {
                ...
                p == z && d.trim(p) != "吉林" ? j.find(".pr").addClass("dn") : j.find(".pr").removeClass("dn");
    ...
    if (/\.cnsuning\.com/ig.test(h)) {
        if (h.indexOf("pre") != -1) {
            ...
            a = g + "//ipservicesit.cnsuning.com"
        }
    } else {
        if (/\.suning\.com/ig.test(h)) {
            a = g + "//ipservice.suning.com"
        } else {
            a = "http://localhost:8080/ip-web"
        }
    }
